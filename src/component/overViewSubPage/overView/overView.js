    ...
    const nonCollapseContent = () =>
    {
        return (
            <div className="d-none d-sm-block">
                ...
                <Jumbotron className="incomeExpenseAreaSize">
                    <Row>
                        <Col className="d-flex justify-content-center verticalDivider">
                            <h5>Income</h5>
                        </Col>
                    ...
                    <Row>
                        <Col className="d-flex justify-content-center verticalDivider">
                            <span className="text-success moneyTextSize"><b>${totalIncome.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</b></span>
                        </Col>
                        <Col className="d-flex justify-content-center">
                            <span className="text-danger moneyTextSize"><b>${totalCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</b></span>
                        </Col>
                    </Row>
                </Jumbotron>
            </div>
